...
Payment_Routes.post("/accounts/:id/payments", dtoValidationMiddleware(CreatePaymentDTO), authMiddleware, paymentController.recordPayment.bind(paymentController));
